...
# 电商订单 · 未发货取消（由客服 FAQ 反推）
# Commerce order · Pre-shipment cancel (reversed from CS FAQ)
...
- 已支付取消不自动返还优惠券（与待支付释放券区分） / Paid cancel does not auto-return coupons (unlike unpaid coupon release)
